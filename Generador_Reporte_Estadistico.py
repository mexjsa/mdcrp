...
<body>
    <div class="app-layout">
        ...
        <main class="main-content">
            ...
            <div class="kpi-row">
                <div class="kpi-card">
                    <div class="kpi-info">
                        <h4>Población Evaluada</h4>
                        <p id="kpi-total">194</p>
                    </div>
            ...
            <div class="dashboard-grid-2">
                ...
                <div class="dashboard-card">
                    <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                        <h3><i class="fa-solid fa-clipboard-check" style="color: var(--primary-accent)"></i> Cobertura de Estudios Realizados</h3>
                        ...
                        <table class="premium-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="color: var(--success-accent); font-weight: 600;">100.0% Sinusal</td>
                                    <td>0.0% Arritmias graves</td>
                                </tr>
                                <tr>
                                    <td>Espirometría Pulmonar</td>
                                    <td style="color: var(--success-accent); font-weight: 600;">100.0% Normal</td>
                                    <td>0.0% Restrictivo/Obstructivo</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <script>
        ...
        function initCharts() {
            ...
            // 2. Gráfico de Cobertura de Estudios Realizados (Horizontal)
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        datalabels: {
                            ...
                            anchor: 'end',
                            align: 'end',
                            color: '#e2e8f0', // Color blanco hueso premium
                            font: {
                                weight: 'bold',
                                size: 10
                            },
                    ...
                    scales: {
                        x: { 
                            beginAtZero: true, 
                            grace: '10%', // Agrega margen al final para que no se recorten las etiquetas
        ...
        function updateDashboard() {
            ...
            filteredData.forEach(p => {
                ...
                if (p.estudios_realizados) {
                    if (p.estudios_realizados.chopo_biometria) studyCounts.biometria++;
                    if (p.estudios_realizados.chopo_quimica) studyCounts.quimica++;
                    if (p.estudios_realizados.chopo_orina) studyCounts.orina++;
                    if (p.estudios_realizados.chopo_antigeno) studyCounts.antigeno++;
                    if (p.estudios_realizados.inbody) studyCounts.inbody++;
                    if (p.estudios_realizados.ekg) studyCounts.ekg++;
                    if (p.estudios_realizados.espirometria) studyCounts.espirometria++;
                    if (p.estudios_realizados.odontograma) studyCounts.odontograma++;
                }
