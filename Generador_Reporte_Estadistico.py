        ...
        <main class="main-content">
            ...
            <div class="dashboard-grid-3">
                ...
                <div class="dashboard-card">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 12px; flex: 1; justify-content: center; padding-top: 10px;">
                        <div style="font-size: 11.5px; font-weight: 700; color: #10b981; text-align: center; margin-top: -15px; margin-bottom: 5px;">
                            Se alcanzó un 91.24% de registros en línea
                        </div>
                        <div style="display: flex; align-items: center; gap: 10px; height: 120px;">
