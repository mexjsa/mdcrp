...
<body>
    <div class="app-layout">
        ...
        <section class="tab-pane" id="page-5">
            ...
            <div class="dashboard-grid-2" style="gap: 12px; margin-bottom: 12px;">
                <div class="dashboard-card" style="padding: 10px 14px;">
                    <div class="card-header" style="padding-bottom: 2px; margin-bottom: 2px;">
                        <h3 style="font-size: 11px;"><i class="fa-solid fa-brain" style="color: var(--primary-accent)"></i> Estrés Percibido (Escala 1 a 5)</h3>
                    </div>
                ...
                <div class="dashboard-card" style="padding: 10px 14px;">
                    <div class="card-header" style="padding-bottom: 2px; margin-bottom: 2px;">
                        <h3 style="font-size: 11px;"><i class="fa-solid fa-smoking" style="color: var(--primary-accent)"></i> Hábitos de Riesgo (Tabaquismo / Alcohol)</h3>
                    </div>
                    <div class="chart-container" style="height: 125px;">
                ...
                <div class="dashboard-card" style="padding: 10px 14px;">
                    <div class="card-header" style="padding-bottom: 2px; margin-bottom: 2px;">
                        <h3 style="font-size: 11px;"><i class="fa-solid fa-person-running" style="color: var(--primary-accent)"></i> Disposición al Cambio (Etapas Prochaska)</h3>
                    </div>
                    <div class="chart-container" style="height: 125px;">
                ...
                <div class="dashboard-card" style="padding: 10px 14px;">
                    <div class="card-header" style="padding-bottom: 2px; margin-bottom: 2px;">
                        <h3 style="font-size: 11px;"><i class="fa-solid fa-gauge-high" style="color: var(--primary-accent)"></i> Hábitos: Confianza e Importancia (Nivel Alto)</h3>
                    </div>
                    <div class="chart-container" style="height: 125px;">
